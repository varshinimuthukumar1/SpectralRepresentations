...
def parse_arguments():
    ...
    parser.add_argument('--sample_patch', type=str, default='data/plane/dart_throwing_256.txt', help='sample patch input')
    parser.add_argument('--outdir', type=str, default='output/', help='scratch folder for output')

    # sampler input
    parser.add_argument('--datadir', type=str, default='data/plane/', help='directory to save the data generated')
